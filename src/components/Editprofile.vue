  ...
  <div id="popup" class="popup">
    <div class="popup-div">
      ...
      <form @submit.prevent="editpersonalinfo" class="row">
        ...
        <div class="col-12">
          <input class="form-control" required v-model="addressInput" type="text" placeholder="Enter address" />
        </div>
      ...
      <form @submit.prevent="editpersonalinfo" class="row">
         <div class="col-12 ">
          <select class="form-select" required v-model="Eduction">
            ...
            <option v-for="eduction in educationalQualifications" :key="eduction" :value="eduction">{{ eduction }}</option>
          </select>
        </div>
         <div class="col-12 ">
        ...
        <div class="col-12 ">
          <select class="form-select" required v-model="Income">
            ...
            <option v-for="income in allAnnualIncomeRanges" :key="income" :value="income">{{ income }}</option>
          </select>
        </div>
        <div class="col-12 text-center">
          <button class="btn btn-success px-5" type="submit">Add</button>
